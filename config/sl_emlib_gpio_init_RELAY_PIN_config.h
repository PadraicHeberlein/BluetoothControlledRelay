#ifndef SL_EMLIB_GPIO_INIT_RELAY_PIN_CONFIG_H
#define SL_EMLIB_GPIO_INIT_RELAY_PIN_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_RELAY_PIN_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_RELAY_PIN_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_RELAY_PIN_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_RELAY_PIN_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_RELAY_PIN
// $[GPIO_SL_EMLIB_GPIO_INIT_RELAY_PIN]
#define SL_EMLIB_GPIO_INIT_RELAY_PIN_PORT        gpioPortD
#define SL_EMLIB_GPIO_INIT_RELAY_PIN_PIN         3
// [GPIO_SL_EMLIB_GPIO_INIT_RELAY_PIN]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_RELAY_PIN_CONFIG_H
