#ifndef SL_EMLIB_GPIO_INIT_BUTTON_CONFIG_H
#define SL_EMLIB_GPIO_INIT_BUTTON_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_BUTTON_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_BUTTON_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_BUTTON_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_BUTTON_DOUT        0
...
#define SL_EMLIB_GPIO_INIT_BUTTON_PIN            7
// [GPIO_SL_EMLIB_GPIO_INIT_BUTTON]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_BUTTON_CONFIG_H
